            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/profile.php?id=61552515584435"
                  ...
                  <a
                    href="https://twitter.com/SairamHkn"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.instagram.com/sec_hkn/"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/in/sec-hkn-nu-eta"
                    aria-label="social-link"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    ...
                    <h3>Email{"  "}</h3>
                    <a
                      href="mailto:sechkn@sairam.edu.in"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
