            ...
            <div className="relative -mx-4 flex items-center justify-between">
              ...
              <div className="flex w-full items-center justify-between px-4">
                ...
                <div className="flex items-center justify-end pr-16 lg:pr-0">
                  ...
                  <img className="w-full dark:hidden sample" style={{width:125, paddingRight:30}} src="/images/logo/2.png"/>
                  <img className="w-full dark:hidden sample" style={{width:140, paddingRight:30}} src="/images/logo/1.png"/>
                  ...
                  <img className="hidden w-full dark:block lg-hidden sample" style={{width:125, paddingRight:30}} src="/images/logo/2.png"/>
